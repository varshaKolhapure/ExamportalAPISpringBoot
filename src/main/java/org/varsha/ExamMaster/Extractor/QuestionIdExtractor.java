...
@Component
public class QuestionIdExtractor implements ResultSetExtractor<QuestionForm>{

	@Override
	public QuestionForm extractData(ResultSet rs) throws SQLException, DataAccessException {
